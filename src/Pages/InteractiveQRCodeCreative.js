            ...
            <div className='hero-section'>
                ...
                <div className='interactive-qr-code-creative__section-container'>
                    <section className='interactive-qr-code-creative__section-container__start'>
                        <h1 className='interactive-qr-code-creative__section-container__title'>Problem</h1>
                        <p className='interactive-qr-code-creative__section-container__text'>• To create a new form that clients need to fill out to launch the new creative design</p>
                        <p className='interactive-qr-code-creative__section-container__text'>• Current creative forms lack the preview visuals to show real time changes, especially when this new creative has interactive elements</p>
                    </section>
                    <section className='interactive-qr-code-creative__section-container__start'>
                        <h1 className='interactive-qr-code-creative__section-container__title'>Solution</h1>
                ...
                <ResponsiveContainer isStickyColumn={isStickyColumn}>
                    ...
                    <Section id="section2">
                        <section className='interactive-qr-code-creative__section-start'>
                            <p className='interactive-qr-code-creative__section-title'>Product Requirements</p>
                    ...
                    <Section id="section3">
                        <section className='interactive-qr-code-creative__section-start'>
                            <p className='interactive-qr-code-creative__section-title'>Competitive Benchmarking - Preview on a Creative Form</p>
                    ...
                    <Section id="section4">
                        <section className='interactive-qr-code-creative__section-start'>
                            <p className='interactive-qr-code-creative__section-title'>Current User Journey - Forms</p>
                    ...
                    <Section id="section5">
                        <section className='interactive-qr-code-creative__section'>
                            <p className='interactive-qr-code-creative__section-title'>Layout Ideation</p>
                    ...
                    <Section id="section6">
                        <section className='interactive-qr-code-creative__section-start'>
                            <p className='interactive-qr-code-creative__section-title'>Iteration &amp; Implementation</p>
                            <p className='interactive-qr-code-creative__lo-fi__text'>Preview is on the right side under general settings (as real time  edits only reflect on preview after that section).</p>
                            <p className='interactive-qr-code-creative__final__text-bold'>Size of Preview</p>
                            <p className='interactive-qr-code-creative__lo-fi__text'>With consideration of the Samsung Ads design system’s grid and column layout, 31.25% scaled version of the preview is chosen for the optimal size that also ensures everything can be seen clearly.</p>
                    ...
                    <Section id="section7">
                        <section className='interactive-qr-code-creative__section-start'>
                            <p className='interactive-qr-code-creative__section-title'>Final Solution</p>
                    ...
                    <Section id="section8">
                        <section style={{marginBottom: '400px'}} className='interactive-qr-code-creative__section-start'>
                            <p className='interactive-qr-code-creative__section-title'>Reflection - What I advocated for and Why?</p>
