        ...
        <main className='creative-preview-gallery'>
            <div className='hero-section'>
                ...
                <div className='creative-preview-gallery__section-container'>
                    <section className='creative-preview-gallery__section-start'>
                        <p className='creative-preview-gallery__section-title'>Problem</p>
                    ...
                    <section className='creative-preview-gallery__section-start'>
                        <p className='creative-preview-gallery__section-title'>Solution</p>
            ...
            <div style={{display: 'flex'}}>
                ...
                <ResponsiveContainer isStickyColumn={isStickyColumn}>
                    ...
                    <Section id="section2">
                        <section className='creative-preview-gallery__section-start'>
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__section-title'>Discovery</p>
                            <h1 style={{ margin: '0' }}className='creative-preview-gallery__research__title'>Understanding End User</h1>
                    ...
                    <Section id="section3">
                        <section className='creative-preview-gallery__section-start'>
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__section-title'>Ideation</p>
                            <p style={{ margin: '0' }} className='creative-preview-gallery__final__text-bold'>Information Architecture Exploration - Chosen direction</p>
                    ...
                    <Section id="section4">
                        <section className='creative-preview-gallery__section-start'>
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__section-title'>Testing</p>
                            <p style={{ margin: '0' }} className='creative-preview-gallery__final__text-bold'>Test Objectives:</p>
                            <p style={{ margin: '0' }} className='creative-preview-gallery__questions__point-text'>• Information Architecture</p>
                            ...
                            <p style={{ marginTop: '20px' }} className='creative-preview-gallery__final__text-bold'>Test Results Summary:</p>
                            <p style={{ margin: '0' }} className='creative-preview-gallery__questions__point-text'>• Icons and visual representation of how the creative will look was very successful</p>
                    ...
                    <Section id="section5">
                        <section className='creative-preview-gallery__section-start'>
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__section-title'>Iteration</p>
                            <p style={{ margin: '0' }} className='creative-preview-gallery__questions__text'>Since the overall layout was well received, there was no need to change. The side panel was the part that needed the most reiteration.</p>
                            <h1 style={{ marginTop: '30px' }} className='creative-preview-gallery__lo-fi__title'>Translating User Test Findings into Iteration - What I changed and the Reasoning</h1>
                            <ul style={{margin: '0px'}}>
                    ...
                    <Section id="section6">
                        <section className='creative-preview-gallery__section-start'>
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__section-title'>Final Solution</p>
                            ...
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__final__text-bold'>CTV/OLV</p>
                            <div className='creative-preview-gallery__img-text-container__wrapper'>
                            ...
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__final__text-bold'>Samsung TV Native</p>
                            <div className='creative-preview-gallery__img-text-container__wrapper'>
                            ...
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__final__text-bold'>Samsung Mobile Native</p>
                            <div className='creative-preview-gallery__img-text-container__wrapper'>
                            ...
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__final__text-bold'>Displays</p>
                            <div className='creative-preview-gallery__img-text-container__wrapper'>
                    ...
                    <Section id="section7">
                        <section className='creative-preview-gallery__section-start margin-end'>
                            <p style={{ marginTop: '40px' }} className='creative-preview-gallery__section-title'>Reflection</p>
                            <p style={{ margin: '0' }} className='creative-preview-gallery__final__text-bold'>What I learned that improved my design process</p>
                            ...
                            <p style={{ margin: '0' }} className='creative-preview-gallery__final__text-bold'>Key Benefits</p>
